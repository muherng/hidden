...
if __name__ == "__main__":
    ...
    dataset = AssociativeRecallDataset(
        vocab_size=8192,        # Size of vocabulary
        num_examples=1000,      # Number of examples to generate
        input_seq_len=64,       # Length of input sequences
        seed=0,                 # Random seed for reproducibility
        power_a=1.0,          # Power law parameter for query distribution
        num_kv_pairs=8         # Number of key-value pairs
    )
