#!/bin/bash
#SBATCH --job-name=gated_deltanet_curriculum
#SBATCH --account=lingo
#SBATCH --partition=csail-shared-h200
#SBATCH --qos=shared-if-available
#SBATCH --time=24:00:00
#SBATCH --output=state_tracking/logs/curriculum_gated_deltanet_%j.log
#SBATCH --error=state_tracking/logs/curriculum_gated_deltanet_%j.err
#SBATCH --gpus=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=64G

# ============================================
# Gated DeltaNet Curriculum Learning (max_len 2 → 18)
# ============================================
# This script trains gated_deltanet on progressively longer sequences,
...
echo "============================================"
echo "Gated DeltaNet Curriculum Learning: ${START_LEN} → ${MAX_LEN}"
...
echo "Final model saved to: ${CHECKPOINT_DIR}/gated_deltanet_len${MAX_LEN}/"
echo "============================================"
