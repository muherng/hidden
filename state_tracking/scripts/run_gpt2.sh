#!/bin/bash
#SBATCH --job-name=state_tracking_gpt2
#SBATCH --account=lingo
#SBATCH --partition=csail-shared-h200
#SBATCH --qos=shared-if-available
#SBATCH --time=24:00:00
#SBATCH --output=state_tracking/logs/gpt2_%j.log
#SBATCH --error=state_tracking/logs/gpt2_%j.err
#SBATCH --gpus=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=64G

# ============================================
# GPT2 (12 layers) Training for State Tracking
# ============================================
...
echo "============================================"
echo "GPT2 State Tracking Training"
echo "Job ID: ${SLURM_JOB_ID}"
echo "Model: ${MODEL} (12 layers, 768 hidden, 12 heads)"
