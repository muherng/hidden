#!/bin/bash
#SBATCH --job-name=state_tracking_gated_deltanet
#SBATCH --account=lingo
#SBATCH --partition=csail-shared-h200
#SBATCH --qos=shared-if-available
#SBATCH --time=24:00:00
#SBATCH --output=state_tracking/logs/gated_deltanet_1e-3_%j.log
#SBATCH --error=state_tracking/logs/gated_deltanet_1e-3_%j.err
#SBATCH --gpus=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=64G

# ============================================
# Gated DeltaNet Training for State Tracking
# ============================================
...
echo "============================================"
echo "Gated DeltaNet State Tracking Training"
