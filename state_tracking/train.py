...
def main():
    ...
    # Model-specific checkpoint naming
    if args.model.lower() in ["gated_deltanet", "gla"]:
        # FLA models don't use T1/T2/chunk_size
        args.output_dir = args.output_dir + f"/{args.model}_len{args.max_len}"
    else:
    ...
    if args.model.lower() in ["gated_deltanet", "gla"]:
        checkpoint_root = root_output + f"/{args.model}_len{args.from_checkpoint}"
    else:
